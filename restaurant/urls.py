...
urlpatterns = [
    ...
    path("ingredients/<int:pk>/update", IngredientUpdateView.as_view(), name="ingredient-form"),
    path("ingredients/<int:pk>/delete", IngredientDeleteView.as_view(), name="ingredient-confirm-delete"),
